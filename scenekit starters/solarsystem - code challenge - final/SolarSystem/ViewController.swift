    ...
    func createSolarSystem() {
        ...
        for planet in planets {
            ...
            if planet.name == "earth" {
                ...
                moonNode.position.z = -planet.distance
                let moon = createNode(from: Planet(name: "moon", radius: 0.15, rotation: 150.degreesToRadians, color: .white, distance: 1))
                moonNode.addChildNode(moon)
